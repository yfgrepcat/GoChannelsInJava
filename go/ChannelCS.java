...
/**
 * Un canal de communication synchrone, qui permet d'envoyer et recevoir des
 * messages de type T.
 */
public interface ChannelCS<T> extends java.rmi.Remote {
    ...
    /**
     * Nom du canal.
     * On suppose que les noms sont uniques (en particulier pour client-serveur ou
     * point-à-point).
     */
